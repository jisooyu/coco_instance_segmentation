...
"""
cloned from https://github.com/akTwelve, created by Adam Kelly


to test the data initially

python ./python/image_composition.py --input_dir ./datasets/traffic_sign_dataset/input \
    --output_dir ./datasets/traffic_sign_dataset/output --count 20 --width 710 --height 710

to generate the train data

python ./python/image_composition.py --input_dir ./datasets/traffic_sign_dataset/input \
    --output_dir ./datasets/traffic_sign_dataset/train --count 2000 --width 710 --height 710

to put out the val data

python ./python/image_composition.py --input_dir ./datasets/traffic_sign_dataset/input \
    --output_dir ./datasets/traffic_sign_dataset/val --count 200 --width 710 --height 710
"""
...
class ImageComposition():
    ...
    def _transform_foreground(self, fg, fg_path):
        ...
        print('check path  ', fg_path)
        fg_image = Image.open(fg_path)
        print('print channel 0 ', fg_image.getchannel(0) )
