...
to create coco_instances.json for train

python ./python/coco_json_utils.py -md ./datasets/traffic_sign_dataset/train/mask_definitions.json \
    -di ./datasets/traffic_sign_dataset/train/dataset_info.json


to create coco_instances.json for val

python ./python/coco_json_utils.py -md ./datasets/traffic_sign_dataset/val/mask_definitions.json \
